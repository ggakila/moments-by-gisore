...
// 					ments
// 				</h1>
// 				<div className="w-1/3 absolute top-[80px] left-1/2 mt-4">
// 					<input
// 						type="text"
// 						placeholder="Search images by name displayed beneath it..."
// 						className="w-full px-3 py-2 rounded-md border border-neutral-700 bg-neutral-800 text-white focus:outline-none focus:border-neutral-100"
// 						value={searchQuery}
